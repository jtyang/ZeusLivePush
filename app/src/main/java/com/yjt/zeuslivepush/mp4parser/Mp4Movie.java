...
public class Mp4Movie {
    ...
    public int addTrack(MediaFormat mediaFormat, boolean isAudio, ArrayList<byte[]> spsList, ArrayList<byte[]> ppsList) throws Exception {
        tracks.add(new Track(tracks.size(), mediaFormat, isAudio,spsList,ppsList));
